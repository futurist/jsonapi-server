...
jsonApi.define = function(resourceConfig) {
  ...
  resourceConfig._resources = jsonApi._resources
  ...
  resourceConfig.searchParams = _.assign({
    ...
    filter: ourJoi.Joi.any()
      ...
      .example("title"),
    noextra: ourJoi.Joi.any()
      .description("no extra field for output")
      .example("&noextra=1"),
    norelation: ourJoi.Joi.any()
      .description("no relation field for output")
      .example("&noextra=1"),
    joitype: ourJoi.Joi.any()
      .description("include joitype in meta")
      .example("&joitype=1"),
    parent: ourJoi.Joi.string()
      .description("parent table to include")
      .example("&parent=lahuojihua"),
...
jsonApi.start = function() {
  if(jsonApi._apiConfig.auth) router.setupAuth()
  routes.register();
